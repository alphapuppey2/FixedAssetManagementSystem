...
<div id="cancelRequestModal" class="fixed inset-0 z-10 flex items-center justify-center bg-gray-500 bg-opacity-75 hidden z-[1000]" aria-labelledby="modal-title" role="dialog" aria-modal="true" >
    ...
    <div class="bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full w-11/12 max-w-md"> <!-- Adjusted for small screens -->
        ...
        <div class="bg-gray-50 px-6 py-4 sm:px-6 flex flex-col sm:flex-row justify-between sm:justify-end space-y-3 sm:space-y-0 sm:space-x-3">
        {{-- <div class="bg-gray-50 px-6 py-4 sm:px-6 flex justify-between space-x-3"> --}}
        {{-- <div class="bg-gray-50 px-6 py-4 sm:px-6 flex justify-between sm:justify-end space-x-3"> --}}
            <!-- No Button -->
            {{-- <form method="POST" id="noForm"> --}}
            <form method="POST" id="noForm" class="w-full sm:w-auto"> <!-- Adjusted for small screens -->
                ...
                <button type="button" onclick="hideModal()" class="inline-flex justify-center items-center rounded-md border border-gray-300 shadow-sm px-4 py-2 w-full sm:w-28 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    No
                </button>
            </form>
            ...
            <form method="POST" id="cancelForm">
                ...
                <button type="submit" class="inline-flex justify-center items-center rounded-md border border-transparent shadow-sm px-4 py-2 w-full sm:w-28 bg-blue-900 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                    Yes
                </button>
            </form>
        </div>
