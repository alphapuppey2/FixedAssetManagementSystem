<x-guest-layout>
    ...
    <div class="contentContainer flex flex-col items-center justify-center min-h-screen px-4">
       <div class="z-10 w-full max-w-xs sm:max-w-sm">
            ...
            <form method="POST" action="{{ route('login') }}" class="needs-validation" novalidate>
                @csrf
                <div class="w-full">
                    <div class="w-full p-8 space-y-6 bg-white rounded-lg shadow-md border border-gray-300">
                        <div class="border-b border-black py-4 mb-4">
                            <h2 class="text-xl md:text-2xl font-bold text-center">LOGIN</h2>
                        </div>
                        ...
                        <div class="flex justify-center mt-6">
                            <button type="submit"
                                    class="w-full px-4 py-2 text-lg font-medium text-white bg-customButtonBlue rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                LOGIN
                            </button>
                        </div>
                    </div>
