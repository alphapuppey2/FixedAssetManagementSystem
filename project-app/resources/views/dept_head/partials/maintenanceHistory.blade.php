            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="border border-gray-300 px-4 py-2">
                        {{ isset($item->lname) || isset($item->fname) ? $item->fname . ' ' . $item->lname : "System Generated" }}
                    </td>
                    ...
                    <td class="border border-gray-300 px-4 py-2 text-center">
                        {{ isset($item->authorized_fname) || isset($item->authorized_lname) ? $item->authorized_fname . ' ' . $item->authorized_lname : "N/A" }}
                    </td>
