...
@section('header')
    ...
    <button id="saveBTN" type="submit" form="formEdit" class="text-blue-500 text-[12px] hidden">SAVE</button>
    <button id="cancelBTN" class="text-blue-500 text-[12px] hidden">CANCEL</button>
@endsection
@section('content')
    <div class=" w-full h-full">
        ...
        <form id="formEdit" action="{{ route('assetDetails.edit', $data->id) }}"
            class="details relative grid grid-cols-[1fr_30%] gap-2 h-full" method="POST">
            @csrf
            @method('PUT')
            <div class="information">
                <div
                    class="leftDetail text-sm grid grid-rows-6 grid-flow-col grid-col-[repeat(50%_50%)] gap-1 items-center">
                    <div id="name" class="info flex grid grid-cols-2 gap-2 pb-1 items-center">
                        ...
                        <x-text-input class="text-sm edit hidden" name='name' value="{{ $data->name }}"></x-text-input>
                    </div>
                    ...
                    <div class="info flex grid grid-cols-2 gap-2 pb-1 items-center">
                        ...
                        {{-- EDIT --}}
                        <x-text-input class="text-sm edit hidden" value="{{ $data->salvageVal }}"></x-text-input>
                    </div>
                    <div class="info flex grid grid-cols-2 gap-2 pb-1 items-center">
            ...
            <div class="right bg-indigo-400 flex flex-col">
    ...
    @vite(['resources/js/editAsset.js', 'resources/js/displayImage.js', 'resources/js/updateDetails.js'])
@endsection
