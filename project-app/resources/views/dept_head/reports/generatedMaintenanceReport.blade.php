    ...
    <div class="min-h-screen bg-gray-50 flex flex-col justify-between">
        <div class="flex-grow overflow-y-auto p-4 md:p-6 bg-white shadow-lg rounded-lg">
            ...
            <div class="overflow-x-auto">
                <table
                    class="w-full min-w-[600px] md:min-w-[800px] table-auto border-collapse bg-white border border-gray-300">
                ...
                <!-- Display Total Cost if Cost Field is Selected -->
                @if ($totalCost !== null)
                    <div class="text-right mt-4 text-lg font-semibold">
                        Total Cost: <span class="text-blue-600">{{ number_format($totalCost, 2) }}</span>
                    </div>
                @endif
