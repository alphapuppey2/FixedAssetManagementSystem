...
@section('content')
    <div class="container mx-auto px-4 py-6 max-w-full">
        ...
        <div id="loadingOverlay"
            class="fixed inset-0 bg-gray-800 bg-opacity-75 flex flex-col items-center justify-center hidden">
