<!-- resources/views/dept_head/modal/assetCustomFilter.blade.php -->
        ...
        <div class="space-y-4 mb-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="name" name="Name" value="name" class="text-blue-500">
                    <span>Name</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="code" name="Asset Code" value="code" class="text-blue-500">
                    <span>Asset Code</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="purchase_date" name="Purchase Date" value="purchase_date" class="text-blue-500">
                    <span>Purchase Date</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="usage_lifespan" name="Usage Lifespan" value="usage_lifespan" class="text-blue-500">
                    <span>Usage Lifespan</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="salvage_value" name="Salvage Value" value="salvage_value" class="text-blue-500">
                    <span>Salvage Value</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="purchase_cost" name="Purchase Cost" value="purchase_cost" class="text-blue-500">
                    <span>Purchase Cost</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="depreciation" name="Depreciation" value="depreciation" class="text-blue-500">
                    <span>Depreciation</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="status" name="Status" value="status" class="text-blue-500">
                    <span>Status</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="ctg_ID" name="Category" value="ctg_ID" class="text-blue-500">
                    <span>Category</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="dept_ID" name="Department" value="dept_ID" class="text-blue-500">
                    <span>Department</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="manufacturer_key" name="Manufacturer" value="manufacturer_key" class="text-blue-500">
                    <span>Manufacturer</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="model_key" name="Model" value="model_key" class="text-blue-500">
                    <span>Model</span>
                </label>
                <label class="flex items-center space-x-2">
                    <input type="checkbox" id="loc_key" name="Location" value="loc_key" class="text-blue-500">
                    <span>Location</span>
                </label>
            </div>
        </div>
