...
@section('content')
    <div class="contents capitalize">
        ...
        <form action="{{ route('asset.create') }}" method="post" class="flex flex-col relative" enctype="multipart/form-data">
            ...
            <div class="formbox">
                <div
                    class="formInformation max-md:flex max-md:flex-col md:grid md:grid-cols-[auto_auto] md:grid-rows-[1fr,30%]  gap-4">
                    <div class="imgContainer flex flex-col items-center space-y-4 col-start-2">
                    ...
                    <div class="formFields flex flex-col gap-2 md:row-start-1 md:col-start-1">
                        ...
                        <div class="grpInline grid lg:grid-cols-2 gap-4">
                            <div class="form-group">
                        ...
                        <div class="grpInline grid md:grid-cols-2 max-md:grid-cols-1 gap-4">
                            <div class="form-group">
                                <x-input-label for='lifespan'>Lifespan (Years)</x-input-label>
                        ...
                        <div class="form-group">
                            <x-input-label for='depreciation'>Depreciation (Per Year)</x-input-label>
                            <x-text-input type="text" id="depreciation" value="0.00" name='depreciation' readonly
                                class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                        </div>

                        <div class="grpInline grid grid-cols-2 gap-4">
                            <div class="form-group">
                    ...
                    <div class="form-group images flex items-center flex-col AdditionalInfo">
                        ...
                        <div class="customFields flex flex-col w-full mt-4">
                            <div class="w-full text-[20px] capitalize font-semibold">
                                    ...
                                    <div class="fieldSet mt-2 {{ isset($addInfos) ? 'grid grid-cols-2 gap-2' : 'flex' }}">
                                        @if ($addInfos)
                                            @foreach ($addInfos as $key => $dataItem)
                                                ...
                                                <input type="$dataItem->type" name="field[key][]" placeholder="key"
