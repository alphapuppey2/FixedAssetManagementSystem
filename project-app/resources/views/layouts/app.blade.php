...
<body class="font-sans antialiased">
        ...
        @endif
        <!-- Page Content -->
    <main class="h-full relative md:left-[205px] md:w-[calc(100%_-_205px)] max-md:left-[50px] max-md:w-[calc(100%_-_50px)] pl-5 pr-5 top-[50px]">
        <div class="flex flex-wrap items-center w-full relative">
            @yield('header')
        </div>
