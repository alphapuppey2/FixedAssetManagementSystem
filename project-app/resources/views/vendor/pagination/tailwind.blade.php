                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <!-- Highlight current page with a background color -->
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white bg-blue-500 border border-blue-600 cursor-default leading-5 dark:bg-blue-700 dark:border-blue-800">
                                            {{ $page }}
                                        </span>
                                    </span>
                                @else
